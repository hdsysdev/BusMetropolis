...
public class OrderOnStockTests {
	...
	private void testInit2() throws AlreadyCustomerException {
		testInit();
		Address addr = new Address("10 Broad Street", "B16 7SD", "Birmingham", "UK");
	...
	@Test
	public void testRegisterCustomerPositive() throws AlreadyCustomerException {
	...
	public void testRegisterCustomerNegative() throws AlreadyCustomerException {
		...
		Address addr = new Address("7 Petonville Rd", "NW7 5GS", "London", "UK");
		oos.registerCustomer("John Paul Smith", addr, "john.smith@gmail.com", "TrustNo1");
	}
	
	@Test
	public void testOrderProductPositive() 
			throws AlreadyCustomerException, NoProductException, NoCustomerException {
	...
	@Test
	public void testOrderProductNegative1() throws AlreadyCustomerException, NoCustomerException  {
		testInit2();
		try {
